...
interface Commands{submit(event:{eventId:string;intentId:string}):Promise<void>;cancel(event:{eventId:string;intentId:string;cancelIntentId:string}):Promise<void>}
