...
export function calculateScreenerMetrics(input: MetricInput): Partial<StockMetrics> {
  ...
  return {
    ...
    grossMargin: revenue[0] && costOfRevenue[0] !== undefined ? ((revenue[0] - costOfRevenue[0]) / revenue[0]) * 100 : undefined,
